...
/* CY_APP_ID is defined in both project Makefiles */
#if (CY_APP_ID == 0U)
#define CY_APP_FLASH_ADDR CY_APP0_FLASH_ADDR
#define CY_APP_FLASH_ADDR CY_APP0_FLASH_ADDR
#define CY_APP_FLASH_LENGTH CY_APP0_FLASH_LENGTH
#elif (CY_APP_ID == 1U)
#define CY_APP_FLASH_ADDR CY_APP1_FLASH_ADDR
#define CY_APP_FLASH_ADDR CY_APP1_FLASH_ADDR
#define CY_APP_FLASH_LENGTH CY_APP1_FLASH_LENGTH
#else
#error CY_APP_ID must be defined to either 0 or 1
#endif
...
(
    ...
    ".equ __cy_app_id,               " CY_STR(CY_APP_ID) "\n"
    ".equ __cy_product_id,           " CY_STR(CY_PRODUCT_ID) "\n"
    ".equ __cy_checksum_type,        " CY_STR(CY_CHECKSUM_TYPE) "\n"
    ".equ __cy_app_core1_start_addr, " CY_STR(CY_APP_FLASH_ADDR) " \n"
    ".equ __cy_app_verify_start,     " CY_STR(CY_APP_FLASH_ADDR) " \n"
    ".equ __cy_app_verify_length,    " CY_STR(CY_APP_FLASH_LENGTH) " - " CY_STR(CY_BOOT_SIGNATURE_SIZE) "\n"
    ...
    ".equ __cy_memory_0_length,   0x00080000 \n"
