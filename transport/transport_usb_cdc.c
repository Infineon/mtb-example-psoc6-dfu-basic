...
#define USB_DEV_INTR_HIGH_SOURCE    usb_interrupt_hi_IRQn
#define USB_DEV_INTR_MED_SOURCE     usb_interrupt_med_IRQn
#define USB_DEV_INTR_LOW_SOURCE     usb_interrupt_lo_IRQn

#define USB_DEV_INTR_HIGH_PRIORITY  (1U)
#define USB_DEV_INTR_MED_PRIORITY   (2U)
...
static void USB_DEV_Start(void)
{
    ...
    if (false == USB_DEV_initVar)
    {
        static const cy_stc_sysint_t UsbDevIntrHigh =
        {
            ...
            .cm0pSrc      = USB_DEV_INTR_HIGH_SOURCE,
        ...
        static const cy_stc_sysint_t UsbDevIntrMedium =
        {
            ...
            .cm0pSrc      = USB_DEV_INTR_MED_SOURCE,
        ...
        static const cy_stc_sysint_t UsbDevIntrLow =
        {
            ...
            .cm0pSrc      = USB_DEV_INTR_LOW_SOURCE,
...
#ifndef CY_DFU_USB_CDC_TRANSPORT_DISABLE

/*******************************************************************************
* Function Name: Cy_DFU_TransportStart
****************************************************************************//**
*
* This function documentation is part of the DFU SDK API.
* For more detail, see the cy_dfu.h file or DFU SDK API Reference Manual.
*
*******************************************************************************/
...
{
    return USB_CDC_CyBtldrCommRead(buffer, size, count, timeout);
}
...
{
    return USB_CDC_CyBtldrCommWrite(buffer, size, count, timeout);
}

#endif /* CY_DFU_USB_CDC_TRANSPORT_DISABLE */
